...
public class BoxLayoutTest extends JFrame {
    ...
    public void init(){
        ...
        //topPanel设置背景色和合适的按钮
        topPanel.setBackground(new Color(255, 9, 17));
        topPanel.setPreferredSize(new Dimension(414,100));

        //左侧按钮
        JButton leftbutton = new JButton("WE");
        ...
        JButton centerbutton = new JButton("VS");
        centerbutton.setPreferredSize(new Dimension(80,30));
        topPanel.add(centerbutton);

        topPanel.add(Box.createHorizontalGlue());

        //右侧按钮
        JButton rightbutton = new JButton("RW");
        ...
        for (int i=0;i<3;i++){
            ...
            jPanel.setBackground(new Color(66, 154, 246));
